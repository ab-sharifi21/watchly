...
export const HorizontalMediaCard: React.FC<HorizontalMediaCardProps> = ({
  ...
  return (
    <article className="embla__slide group relative h-[170px] w-[270px] flex-none rounded-xl transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.4)]">
      <Link
      ...
      >
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-white opacity-0 transition-all duration-300 group-hover:scale-100 group-hover:opacity-100">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-primary-color/90 shadow-2xl backdrop-blur-sm transition-all duration-300 hover:bg-primary-color">
